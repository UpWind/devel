#ifndef DEPTHAREASHALLOW_H
#define DEPTHAREASHALLOW_H

#include <QObject>
#include "../chartobjectinterface.h"

class DepthAreaShallow: public ChartObjectInterface
{
    Q_INTERFACES(ChartObjectInterface)

public:
    explicit DepthAreaShallow(QVector<QPolygonF> geomPixelData, QVector<QPolygonF> geomCoordinateData,OGRLayer* feat, QString tabName);
    ~DepthAreaShallow();
