...
class Limit: public ChartObjectInterface
{
    Q_INTERFACES(ChartObjectInterface)

public:
    explicit Limit(QVector<QPolygonF> geomPixelData, QVector<QPolygonF> geomCoordinateData,OGRLayer* feat, QString tabName);
    ~Limit();
